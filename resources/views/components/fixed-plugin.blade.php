<div class="fixed-plugin">
    ...
    <div class="card shadow-lg ">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Tipo de navegación</h6>
        </div>
        <div class="d-flex">
          ...
          <button class="btn bg-gradient-primary w-100 px-3 mb-2  {{ (Request::is('rtl') ? 'me-2' : 'ms-2') }}" data-class="bg-white" onclick="sidebarType(this)">Blanco</button>
        </div>
        <!-- Navbar Fixed -->
        <div class="mt-3">
          <h6 class="mb-0">Fijar navegación</h6>
        </div>
